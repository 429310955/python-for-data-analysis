...
<script>
        require(['echarts'], function(echarts) {
                var chart_7c386d073ad44db2a9b21b27bd7ea570 = echarts.init(
                    document.getElementById('7c386d073ad44db2a9b21b27bd7ea570'), 'white', {renderer: 'canvas'});
                var option_7c386d073ad44db2a9b21b27bd7ea570 = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "title": [
        {
            ...
            "itemGap": 10
                ...
                chart_14cc9a81f95d402db82ea58b9301cb57.setOption(option_14cc9a81f95d402db82ea58b9301cb57);
        });
    </script>
...
<div class="tab">
            <button class="tablinks" onclick="showChart(event, 'f8b010edfe8d44e39b6502843e86e784')">点击—购买转化漏斗</button>
            <button class="tablinks" onclick="showChart(event, '6a02c1e9cd6a41758576cf5a3a45db9b')">点击—收藏—购买转化漏斗</button>
            <button class="tablinks" onclick="showChart(event, '4ecab4e431cb4246aa7efd5fc3ab6bc6')">点击—加入购物车—购买转化漏斗</button>
            <button class="tablinks" onclick="showChart(event, 'bbd70347e8f2496d8a9a7ded02805d29')">点击—收藏和加入购物车—购买转化漏斗</button>
    </div>

        <div id="f8b010edfe8d44e39b6502843e86e784" class="chart-container" style="width:900px; height:500px;"></div>
        <div id="6a02c1e9cd6a41758576cf5a3a45db9b" class="chart-container" style="width:900px; height:500px;"></div>
        <div id="4ecab4e431cb4246aa7efd5fc3ab6bc6" class="chart-container" style="width:900px; height:500px;"></div>
        <div id="bbd70347e8f2496d8a9a7ded02805d29" class="chart-container" style="width:900px; height:500px;"></div>

<script>
        require(['echarts'], function(echarts) {
                var chart_f8b010edfe8d44e39b6502843e86e784 = echarts.init(
                    document.getElementById('f8b010edfe8d44e39b6502843e86e784'), 'white', {renderer: 'canvas'});
                var option_f8b010edfe8d44e39b6502843e86e784 = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "title": [
        {
            ...
            "itemGap": 10
                ...
                chart_f8b010edfe8d44e39b6502843e86e784.setOption(option_f8b010edfe8d44e39b6502843e86e784);
                var chart_6a02c1e9cd6a41758576cf5a3a45db9b = echarts.init(
                    document.getElementById('6a02c1e9cd6a41758576cf5a3a45db9b'), 'white', {renderer: 'canvas'});
                var option_6a02c1e9cd6a41758576cf5a3a45db9b = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "title": [
        {
            ...
            "itemGap": 10
                ...
                chart_6a02c1e9cd6a41758576cf5a3a45db9b.setOption(option_6a02c1e9cd6a41758576cf5a3a45db9b);
                var chart_4ecab4e431cb4246aa7efd5fc3ab6bc6 = echarts.init(
                    document.getElementById('4ecab4e431cb4246aa7efd5fc3ab6bc6'), 'white', {renderer: 'canvas'});
                var option_4ecab4e431cb4246aa7efd5fc3ab6bc6 = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "title": [
        {
            ...
            "itemGap": 10
                ...
                chart_4ecab4e431cb4246aa7efd5fc3ab6bc6.setOption(option_4ecab4e431cb4246aa7efd5fc3ab6bc6);
                var chart_bbd70347e8f2496d8a9a7ded02805d29 = echarts.init(
                    document.getElementById('bbd70347e8f2496d8a9a7ded02805d29'), 'white', {renderer: 'canvas'});
                var option_bbd70347e8f2496d8a9a7ded02805d29 = {
    "animation": true,
    "animationThreshold": 2000,
    "animationDuration": 1000,
    "animationEasing": "cubicOut",
    ...
    "title": [
        {
            ...
            "itemGap": 10
                ...
                chart_bbd70347e8f2496d8a9a7ded02805d29.setOption(option_bbd70347e8f2496d8a9a7ded02805d29);
        });
    </script>
<script>
        (function() {
